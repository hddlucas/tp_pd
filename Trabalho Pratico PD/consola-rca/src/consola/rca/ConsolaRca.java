...
public class ConsolaRca {
    ...
    public static void consultProcesses() {

        try {
            System.out.println("\n Lista de Propostas de Aquisicao: \n");
            List<String> proposals = consola.getAcquisitionProposals();

            if ((proposals == null) || (proposals.isEmpty())) {
                System.out.println("Nenhuma Proposta de Aquisicao Encontrada");
            } else {
                for (String u : proposals) {
                    System.out.println(u);
                }
            }
        } catch (Exception ex) {
...
//        System.out.println("10- Consulta Estado dos Processos");
